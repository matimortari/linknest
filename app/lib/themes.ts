export const THEMES = [
  {
    ...
    preferences: {
      ...
      slugFontFamily: "'Playfair Display'",
  ...
  },
  {
    ...
    preferences: {
      ...
      headerTextWeight: "600",
      headerTextSize: "1.1rem",
      headerFontFamily: "'Ribeye Marrow'",
