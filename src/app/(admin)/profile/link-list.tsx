import LinkDialog from "@/src/app/(admin)/profile/link-dialog";
...
import { useGetLinks } from "@/src/hooks/use-queries";
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {isLinksLoading ? (
        ...
        <p className="text-lead my-2 text-center text-muted-foreground">
          No links here yet. Get started!
        </p>
      ) : (
          ...
          {userLinks.map((l: UserLink) => (
            <li key={l.id} className="card">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-label truncate text-muted-foreground">
                  {l.url}
                </p>
              </div>
            </li>
