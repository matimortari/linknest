...
const NavLink = ({ href, icon, label, isActive, onClick }) => (
  <Link
    href={href}
    title={label}
    className={`btn ${isActive ? "btn-selected" : ""}`}
    onClick={onClick}
  >
    ...
    <>
        ...
        <div className="flex flex-row items-center justify-between p-4">
          ...
          <nav className="flex flex-row items-center gap-2">
            ...
            >
              <Icon
                icon={
                  theme === "light" ? "radix-icons:moon" : "radix-icons:sun"
                }
                width={25}
                height={25}
              />
            ...
            <button onClick={() => setIsNavOpen(!isNavOpen)} className="btn">
              <Icon
                icon={isNavOpen ? "mdi:close" : "mdi:menu"}
                width={25}
                height={25}
              />
            </button>
      ...
      >
        ...
        <div className="mt-auto flex flex-col gap-2 py-8">
          ...
          >
            <Icon
              icon={theme === "light" ? "radix-icons:moon" : "radix-icons:sun"}
              width={25}
              height={25}
            />
