  ...
  return (
    ...
    >
      <Icon
        ...
        width={20}
        height={20}
        style={{ color: preferences.iconIconColor }}
      />
    </li>
  );
}
...
function CarouselCard({ presetId }) {
  const { description, links, image, icons, slug, preferences } =
    carouselPresets[presetId];
  ...
  return (
    ...
    >
      <div className="rounded-t-xl bg-gradient-to-r from-primary to-secondary p-1">
        <div className="flex flex-row items-center justify-between rounded-t-xl bg-[#111016] p-2">
          <div className="flex flex-row items-center gap-1">
            <div className="size-2 rounded-full bg-red-500" />
            <div className="size-2 rounded-full bg-yellow-500" />
            <div className="size-2 rounded-full bg-green-500" />
          </div>
          <div className="rounded bg-[#3b3b41] p-1 font-mono text-xs text-[#c7c4c4]">
            @{slug}
          </div>
        </div>
      </div>
